...
export const ENGINES = [
  ...
  },
  {
    id: "llama",
    label: "HF: Llama 3.1",
    hint: "Fast product generation & copy",
  ...
  },
  {
    id: "qwen",
    label: "HF: Qwen 2.5",
    hint: "Deep market research & reasoning",
    model: "Qwen/Qwen2.5-7B-Instruct",
    etaMs: 5000,
  },
  {
    id: "hybrid",
    label: "Hybrid (All at Once)",
    hint: "Parallel engines, synthesized results",
    model: "Llama 3.1 + Qwen 2.5",
    etaMs: 7000,
  },
] as const;
