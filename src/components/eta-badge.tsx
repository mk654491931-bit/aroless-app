  ...
  return (
    <span
      className={`inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-[11px] font-semibold backdrop-blur-xl transition-all duration-500 ${
        running
          ? "border-[oklch(0.62_0.17_255)]/50 bg-[oklch(0.62_0.17_255)]/12 text-[oklch(0.88_0.10_255)] glow"
      ...
      {running ? (
        <>
          <span className="relative flex h-3.5 w-3.5 items-center justify-center">
            <span className="absolute inset-0 rounded-full border border-[oklch(0.72_0.14_255)]/70 border-t-transparent animate-spin" />
            <span className="absolute inset-0 rounded-full bg-[oklch(0.72_0.14_255)]/40 animate-ping" />
          </span>
