    ...
    <section className="glass rounded-2xl overflow-hidden">
      ...
      >
        <label className="text-xs">
          ...
          <div className="flex gap-1">
            <input
              ...
              className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm font-mono uppercase outline-none focus:border-[oklch(0.62_0.17_255)]"
        ...
        <button
          ...
          className="self-end rounded-lg bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] px-4 py-2 text-sm font-semibold text-white disabled:opacity-60"
        >
          {create.isPending ? (
              ...
              (q.data ?? []).map((p) => (
                <tr key={p.id} className="border-t border-white/5 hover:bg-white/[0.02]">
                  <td className="px-5 py-3 font-mono font-semibold">
                    <button
                      onClick={() => copy(p.code)}
                      className="inline-flex items-center gap-1.5 hover:text-[oklch(0.86_0.10_255)]"
                      title="Kopyala"
                    >
                      {p.code}{" "}
                      {copied === p.code ? (
