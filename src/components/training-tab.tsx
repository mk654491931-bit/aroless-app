      ...
      <div className="premium-card rounded-2xl p-4 md:p-5">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              <span className="rounded-lg bg-gradient-to-br from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] p-1.5">
                <Store size={15} />
              </span>
            ...
            <div className="mt-1.5 flex flex-wrap gap-1.5 text-[10px]">
              ...
              <span className="inline-flex items-center gap-1 rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-muted-foreground">
                <Gem size={11} className="text-[oklch(0.78_0.16_255)]" /> Marka {brand}/100
              </span>
              <span className="inline-flex items-center gap-1 rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-muted-foreground">
              ...
              {cal && (
                <span className="inline-flex items-center gap-1 rounded-full border border-[oklch(0.62_0.17_255)]/40 bg-[oklch(0.62_0.17_255)]/12 px-2.5 py-1 text-foreground">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              onClick={() => advance(1)}
              className="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] px-3.5 py-2 text-xs font-semibold glow disabled:opacity-40"
            >
              <Play size={13} /> 1 gün
            </button>
            <button
        ...
        <div className="mt-4 grid md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className="mt-1.5 h-1.5 rounded-full bg-white/8 overflow-hidden">
              <div
                className="h-full rounded-full bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] transition-all"
                style={{ width: `${lvl.pct}%` }}
              />
            </div>
          </div>
        ...
        {nextMission && !over && (
          ...
          >
            <Flag size={14} className="mt-0.5 shrink-0 text-[oklch(0.72_0.18_255)]" />
            <span>
        ...
        {state.status === "finished" && (
          <button
            ...
            className="mt-3 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] px-4 py-2.5 text-xs font-semibold glow"
          >
  ...
  return (
    <div className="space-y-4">
      <div className="premium-card rounded-2xl p-4 flex flex-wrap items-center gap-4">
        <div className="flex items-center gap-2">
          <span className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] font-bold">
            {lvl.level}
          </span>
          <div>
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-2.5 h-1.5 rounded-full bg-white/8 overflow-hidden">
                        <div
                          className={`h-full rounded-full transition-all ${m.done ? "bg-emerald-400" : "bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)]"}`}
                          style={{ width: `${m.pct}%` }}
                        />
                      </div>
    ...
    <div className="grid lg:grid-cols-[1.3fr_1fr] gap-4">
      <div className="space-y-3">
        <h3 className="text-sm font-semibold flex items-center gap-2">
          <ArolessMark size={17} className="text-[oklch(0.78_0.16_255)]" /> Aroless Koçu
        </h3>
        {tips.map((t, i) => (
          <div
            key={i}
      ...
      <div className="premium-card rounded-2xl p-5 space-y-5">
        <div>
          ...
          <input
            ...
            className="mt-1.5 w-full rounded-xl border border-white/10 bg-white/5 px-3.5 py-2.5 text-sm outline-none focus:border-[oklch(0.62_0.17_255)]/60"
          />
        </div>
            ...
            {Object.values(DIFFICULTIES).map((d) => {
              ...
              return (
                <button
                  ...
                  className={`text-left rounded-xl border p-3.5 transition card-lift ${on ? "border-[oklch(0.62_0.17_255)]/60 bg-[oklch(0.62_0.17_255)]/12" : "border-white/10 bg-white/5 hover:bg-white/8"}`}
                >
        ...
        <button
          ...
          className="w-full rounded-xl bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] px-4 py-3 text-sm font-semibold glow"
        >
          Eğitim mağazamı aç
        </button>
...
function Storefront({ state }: { state: SimState }) {
  ...
  return (
    <div className="rounded-2xl border border-white/10 overflow-hidden bg-[oklch(0.16_0.02_255)]">
      {/* fake shop chrome */}
      ...
      <div className="border-b border-white/10 bg-gradient-to-r from-[oklch(0.62_0.17_255)]/25 to-[oklch(0.52_0.15_262)]/15 px-4 py-5">
          ...
          <div key={p.id} className="premium-card rounded-xl p-4">
            ...
            <div className="mt-3 rounded-xl border border-white/10 bg-white/5 px-3 py-2.5">
              <div className="flex flex-wrap items-center justify-between gap-2 text-[11px]">
                <span className="inline-flex items-center gap-1.5 text-muted-foreground">
                  <FlaskConical size={12} className="text-[oklch(0.72_0.18_255)]" /> Kreatif A/B
                  testi
                  {!!(p.cvrBonus ?? 0) && (
            ...
            <div className="mt-4 grid md:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full accent-[oklch(0.62_0.17_255)]"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full accent-[oklch(0.52_0.15_262)]"
                />
                <div className="mt-2 text-[11px] text-muted-foreground">
      ...
      <div className="premium-card rounded-xl p-4">
        ...
        <div className="flex items-end gap-1 h-40">
          {h.map((d) => (
            ...
            >
              <div
                className="w-full rounded-t bg-[oklch(0.62_0.17_255)]/70"
        ...
        <div className="mt-4 space-y-2">
          {card.options.map((o, i) => (
            <button
              key={i}
              onClick={() => onChoose(i)}
              className="w-full text-left rounded-xl border border-white/10 bg-white/5 px-3.5 py-3 hover:bg-white/10 hover:border-[oklch(0.62_0.17_255)]/50 transition card-lift"
            >
...
function GrowthView({
  ...
  return (
    <div className="space-y-4">
      <div className="premium-card rounded-2xl p-4 md:p-5">
        <div className="flex items-center gap-2">
          <Rocket size={15} className="text-[oklch(0.72_0.18_255)]" />
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        <div className="premium-card rounded-2xl p-4 md:p-5">
          <div className="flex items-center gap-2">
            <Mail size={15} className="text-[oklch(0.72_0.18_255)]" />
          ...
          <button
            ...
            onClick={onCampaign}
            className="mt-3 w-full rounded-lg bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] px-3 py-2 text-xs font-semibold glow disabled:opacity-40"
          >
            {cd > 0
...
function MarketView({ state }: { state: SimState }) {
  ...
  return (
    <div className="space-y-4">
      <div className="premium-card rounded-xl p-4">
        ...
        <div className="mt-3 flex h-3 overflow-hidden rounded-full bg-white/8">
          {rows.map((r) => (
            <div
              ...
              className={
                r.you
                  ? "bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)]"
        ...
        <div className="mt-3 space-y-2">
          {rows.map((r) => (
            <div
              key={r.key}
              className={`flex flex-wrap items-center gap-2 rounded-xl border px-3 py-2 text-xs ${r.you ? "border-[oklch(0.62_0.17_255)]/40 bg-[oklch(0.62_0.17_255)]/10" : "border-white/10 bg-white/5"}`}
            >
      ...
      <div className="premium-card rounded-xl p-4">
        <h3 className="flex items-center gap-2 text-sm font-semibold">
          <Gem size={14} className="text-[oklch(0.78_0.16_255)]" /> Marka değeri {brand}/100
        </h3>
        ...
        <div className="mt-3 space-y-2">
          {CALENDAR.map((c) => {
            ...
            return (
              <div
                key={c.title}
                className={`rounded-xl border px-3 py-2 text-xs ${active ? "border-[oklch(0.62_0.17_255)]/40 bg-[oklch(0.62_0.17_255)]/10" : past ? "border-white/10 bg-white/5 opacity-50" : "border-white/10 bg-white/5"}`}
              >
