...
export function TrainingSection({ catalog, onUpgrade }: { catalog: WinningProduct[]; onUpgrade: () => void }) {
  ...
  return (
    <div className="space-y-5">
      ...
      {mode === "sandbox" ? <SandboxTab catalog={catalog} onUpgrade={onUpgrade} /> : <TrainingTab catalog={catalog} />}
    </div>
  );
}
