  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-1.5 bg-gradient-to-b from-black/50 to-black/75 px-4 text-center">
        ...
        <span className="mt-1 inline-flex items-center gap-1 rounded-lg bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] px-3 py-1.5 text-[11px] font-semibold text-white">
...
export function LockedPanel({
  ...
  return (
    <div className="glass mx-auto max-w-xl rounded-2xl p-8 text-center">
      ...
      <button
        onClick={onUpgrade}
        className="mt-5 inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] px-4 py-2 text-sm font-semibold text-white"
      >
