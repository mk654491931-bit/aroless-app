  ...
  return (
    ...
    >
      ...
      <g
        style={
          animated
            ? { transformOrigin: "24px 24px", animation: "vm-spin 7s linear infinite" }
            : undefined
        }
      >
        <ellipse
      ...
      {/* neural nodes + links */}
      <path
        d="M24 24 17 15M24 24l9-4M24 24l-3 12"
        stroke="currentColor"
        strokeWidth="1.5"
        opacity="0.6"
        strokeLinecap="round"
      ...
      <circle
        ...
        style={
          animated
            ? { transformOrigin: "24px 24px", animation: "vm-pulse 2.6s ease-in-out infinite" }
            : undefined
        }
      />
