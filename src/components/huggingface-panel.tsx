    ...
    <section className="glass rounded-2xl p-5">
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        <input
          ...
          className="flex-1 rounded-lg border border-white/10 bg-white/5 px-3 py-2.5 text-sm outline-none transition focus:border-[oklch(0.62_0.17_255)]"
        />
        <button
          onClick={save}
          className="rounded-lg bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] px-4 py-2.5 text-sm font-semibold text-white glow"
        >
          Save & Test
        </button>
        <button
