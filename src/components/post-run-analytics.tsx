    ...
    <div className="space-y-5">
      ...
      >
        ...
        <div className="relative flex flex-wrap items-center gap-6">
          ...
          <button
            onClick={onRestart}
            className="rounded-xl px-5 py-3 text-sm font-bold bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] text-white glow flex items-center gap-2"
          >
      ...
      <div className="glass rounded-2xl p-5">
        ...
        <StackedBar
          rows={[
            { label: "Ad spend", value: totalAd, color: "oklch(0.62 0.17 255)" },
      ...
      <div className="glass rounded-2xl p-5">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex gap-3 text-[10px] uppercase tracking-wider text-muted-foreground">
            ...
            <span className="inline-flex items-center gap-1">
              <span className="w-2 h-2 rounded-full bg-[oklch(0.68_0.15_255)]" />
              Capital
            </span>
          </div>
        </div>
              ...
              return (
                <div key={d.day} className="flex-1 flex flex-col justify-center relative group">
                  ...
                  <div className="absolute inset-x-0" style={{ top: `${100 - capPct}%` }}>
                    <div className="w-full h-[2px] bg-[oklch(0.68_0.15_255)]/60" />
                  </div>
...
function computeGrade(roi: number, rating: number, roas: number) {
  ...
  if (score >= 15)
    return {
      ...
      textCls: "text-[oklch(0.68_0.15_255)]",
      bgCls: "bg-[oklch(0.62_0.17_255)]/15",
      borderCls: "border-[oklch(0.62_0.17_255)]/40",
      glowCls: "bg-[oklch(0.62_0.17_255)]/25",
    };
  if (score >= -10)
    return {
      letter: "C",
