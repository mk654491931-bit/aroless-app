    ...
    <div className="premium-card grain rounded-2xl p-4 mb-4">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2 text-sm font-semibold">
          <SlidersHorizontal size={14} className="text-[oklch(0.68_0.15_255)]" />
          Advanced filters
    ...
    <div>
      ...
      <div className="flex gap-2">
        <input
          ...
          className="w-1/2 rounded-lg bg-white/5 border border-white/10 px-2 py-1.5 text-xs outline-none focus:border-[oklch(0.62_0.17_255)]"
        />
        <input
          type="number"
          min={0}
  ...
  return (
    <label className="block">
      ...
      <select
        ...
        className="w-full rounded-lg bg-white/5 border border-white/10 px-2 py-1.5 text-xs outline-none focus:border-[oklch(0.62_0.17_255)]"
      >
        {options.map((o) => (
