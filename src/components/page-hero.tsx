    ...
    <section className="page-hero mb-6">
      <div className="relative z-10 flex flex-wrap items-start justify-between gap-4">
        <div className="flex min-w-0 items-start gap-3">
          {icon && (
            <span className="mt-0.5 inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-brand">
              {icon}
            </span>
          )}
          <div className="min-w-0">
            <h1 className="wrap-break-word text-xl font-black tracking-tight md:text-2xl">
              {title}
            </h1>
            {description && (
