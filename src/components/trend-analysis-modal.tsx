...
export function TrendAnalysisModal({
  ...
  return (
    ...
    >
      <div
        className="max-h-[88dvh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-white/10 bg-[oklch(0.18_0.03_255)] p-5 shadow-2xl"
        ...
        {data && (
          <div className="mt-4 space-y-4">
            <div className="flex flex-wrap items-center gap-2">
              <span className="rounded-full bg-gradient-to-r from-[oklch(0.62_0.17_255)] to-[oklch(0.52_0.15_262)] px-3 py-1 text-sm font-bold text-white">
            ...
            {data.ai_comment && (
              <div className="rounded-xl border border-white/10 bg-gradient-to-br from-[oklch(0.62_0.17_255)]/10 to-transparent p-3">
