  ...
  return (
    <div className="rounded-xl border border-white/10 bg-white/[0.03]">
      <div className="flex items-center gap-2 px-4 py-3">
        ...
        >
          <Radar size={14} className="text-[oklch(0.68_0.15_255)]" />
          Derin arama
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <Field label="Rekabet tercihi">
              <select
                ...
                className={inputCls}
              >
                <option value="any" className="bg-[oklch(0.20_0.035_255)]">
                  Farketmez
                </option>
                <option value="low" className="bg-[oklch(0.20_0.035_255)]">
            ...
            <Field label="Ürün olgunluğu">
              ...
              >
                ...
                <option value="fresh" className="bg-[oklch(0.20_0.035_255)]">
                  Yeni yükselen (son 30-60 gün)
                </option>
                <option value="proven" className="bg-[oklch(0.20_0.035_255)]">
                  Kanıtlanmış satıcı
                </option>
              </select>
            </Field>
...
const inputCls =
  "w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm outline-none focus:border-[oklch(0.62_0.17_255)]";
