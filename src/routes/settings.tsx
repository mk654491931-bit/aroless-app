            ...
            {CURRENCIES.map((c) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-lg border px-3 py-2.5 text-sm font-medium transition ${on ? "border-[oklch(0.62_0.17_255)] bg-gradient-to-r from-[oklch(0.62_0.17_255)]/20 to-[oklch(0.52_0.15_262)]/20" : "border-white/10 bg-white/5 hover:bg-white/10"}`}
                >
                  {c}
                </button>
              );
        ...
        <section className="glass rounded-2xl p-5">
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            <input
              ...
              className="h-4 w-4 rounded accent-[oklch(0.62_0.17_255)]"
            />
